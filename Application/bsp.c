...
void App_TimeTickHook(void) {
    ...
    /* Process all time events for active objects */
    TimeEvent_tick();
...
/* Idle task hook, Enters low-power mode when idle ===============================================*/
void App_TaskIdleHook(void) {
#ifdef NDEBUG
    __WFI(); /* Wait-For-Interrupt */
#endif
}
/* Empty hooks (required by uC/OS-II, implemented as stubs) ===============================================*/
...
void BSP_init(void) {
    ...
    */
    ...
    /* Before returning, clear LEDs initially */
...
void BSP_start(void) {
    ...
    */
    ...
    /* set up the SysTick timer to fire at OS_TICKS_PER_SEC rate
